...
int main(int argc, char** argv) {
	...
	try {
		...
		std::cout << mp_test.upper_bound(3)->second << std::endl;
		std::cout << mp_test.lower_bound(2)->second << std::endl;
		std::cout << mp_test.find(3)->second << std::endl;
		...
		std::cout << pr.first->first << pr.first->second << pr.second->first << pr.second->first << std::endl;
		...
		std::cout << mp_str.upper_bound("yo")->second << std::endl;
		std::cout << mp_str.lower_bound("hello")->second << std::endl;
		std::cout << mp_str.find("sup")->second << std::endl;
		...
		std::cout << prstr.first->first << prstr.first->second << prstr.second->first << prstr.second->first << std::endl;
